...
const static int MVD_ALG_STS_ERR_MVBCOLOR_COLOR_MEASURE_SOLAR_PANEL_CORR_INPUT_IMG_NUM = 0x10107048;      ///< ch: 光伏板评分校正功能输入图像数量错误
const static int MVD_ALG_STS_ERR_MVBCOLOR_COLOR_MEASURE_SOLAR_PANEL_SCORE_EDGE_RATIO   = 0x10107049;      ///< ch: 光伏板评分功能边缘比例错误
const static int MVD_ALG_STS_ERR_MVBCOLOR_COLOR_MEASURE_SOLAR_PANEL_SCORE_EDGE_WEIGHT  = 0x1010704A;      ///< ch: 光伏板评分功能边缘权重错误
const static int MVD_ALG_STS_ERR_MVBCOLOR_COLOR_MEASURE_SOLAR_PANEL_SCORE_MASK         = 0x1010704B;      ///< ch: 光伏板评分功能需要输入模板图像
const static int MVD_ALG_STS_ERR_MVBCOLOR_MODU_FORMAT_CONVERT_DISABLE                  = 0x1010704C;      ///< ch: 颜色格式转换模块模块无效
const static int MVD_ALG_STS_ERR_MVBCOLOR_PARAM_FORMAT_CONVERT_IDX_CONVERT_TYPE        = 0x1010704D;      ///< ch: 颜色格式转换方式参数错误
...
const static int MVD_ALG_STS_ERR_MVBPREPRO_PARAM_HOME_WARP_INTER_TYPE           =0x1010608A;      // Home映射插值参数错误
...
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_LINE_PAIR_DEFECT_INSP_GRAY_UNEVEN_ENABLE        =0x10109123;   ///< ch: 亮度不均检测使能参数错误
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_LINE_PAIR_DEFECT_INSP_GRAY_UNEVEN_POLARITY      =0x10109124;   ///< ch: 亮度不均测的极性参数错误
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_LINE_PAIR_DEFECT_INSP_GRAY_UNEVEN_CONTRAST                 =0x10109125;   ///< ch: 亮度不均检测的对比度阈值参数错误
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_LINE_PAIR_DEFECT_INSP_GRAY_UNEVEN_TOTAL_LEN_THRESH         =0x10109126;   ///< ch: 亮度不均检测的累计长度阈值参数错误
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_LINE_PAIR_DEFECT_INSP_GRAY_UNEVEN_SCALING                  =0x10109127;   ///< ch: 亮度不均检测区域缩放比例参数错误
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_LINE_PAIR_DEFECT_INSP_BRIGHTNESS_DIS_THRESH				  =0x10109128;   ///< ch: 直线对亮度缺陷（明缺陷）进行检测的点对宽度阈值参数错误
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_FLAW_NO_MOD_INPUT_MODEL_ROI_NUM_ERROR            =0x10109129;   ///< ch: 输入的模型轨迹数与实际检测轨迹数不相同
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_FLAW_NO_MOD_UPDATE_METHOD_ERROR				  =0x1010912A;   ///< ch: 模型更新方式错误
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_WIDTH_THRESH_ENABLE_ERROR						  =0x1010912B;   ///< ch: 边缘对宽度阈值范围使能 参数异常
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_WIDTH_LOW_THRESH_ERROR							  =0x1010912C;   ///< ch: 边缘对最小宽度阈值 参数异常
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_WIDTH_HIGH_THRESH_ERROR                          =0x1010912D;   ///< ch: 边缘对最大宽度阈值 参数异常
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_GRAY_THRESH_ENABLE_ERRO						  =0x1010912E;   ///< ch: 边缘对灰度阈值范围使能 参数异常
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_GRAY_LOW_THRESH_ERROR							  =0x1010912F;   ///< ch: 边缘对最小灰度范围 参数异常
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_GRAY_HIGH_THRESH_ERROR							  =0x10109130;   ///< ch: 边缘对最大灰度范围 参数异常
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_FLAW_POS_LOW_THRESH_ERROR						  =0x10109131;   ///< ch: 宽度阈值范围使能 参数异常
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_GRAY_UNEVEN_ENABLE								  =0x10109132;   ///< ch: 亮度不均检测使能参数错误
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_GRAY_UNEVEN_POLARITY							  =0x10109133;   ///< ch: 亮度不均测的极性参数错误
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_FLAW_GRAY_UNEVEN_CONTRAST						  =0x10109134;   ///< ch: 亮度不均检测的对比度阈值参数错误
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_FLAW_GRAY_UNEVEN_TOTAL_LEN_THRES				  =0x10109135;   ///< ch: 亮度不均检测的累计长度阈值参数错误
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_EDGE_PAIR_FLAW_INSP_GRAY_UNEVEN_SCALING					  =0x10109136;   ///< ch: 亮度不均检测区域缩放比例参数错误
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_EDGE_PAIR_FLAW_BRIGHTNESS_DIS_THRESH_ERROR                       =0x10109137;   ///< ch: 亮缺陷最小宽度阈值 参数异常
const static int MVD_ALG_STS_ERR_MVBEDGEINSP_PARAM_LINE_PAIR_DEFECT_INSP_BRIGHTNESS_SCALE_ERROR               =0x10109138;   ///< ch: 亮缺陷检测区域缩放比例参数错误
