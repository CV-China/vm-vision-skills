...
const static int MVD_E_OUTOF_MEMORY          = 0x8010001A;    ///< 申请cpu内存失败 | en:Fail to allocate cpu memory table
const static int MVD_E_OUTOF_GPUMEMORY       = 0x8010001B;    ///< 申请gpu内存失败 | en:Fail to allocate gpu memory table
