...
echo xcopy "%~dp0x64\Release\*.dll" "%xmlpath%" /y /i
xcopy "%~dp0x64\Release\*.dll" "%xmlpath%" /y /i

echo xcopy "%~dp0x64\Release\*.pdb" "%xmlpath%" /y /i
xcopy "%~dp0x64\Release\*.pdb" "%xmlpath%" /y /i
@echo ---------------------------------
